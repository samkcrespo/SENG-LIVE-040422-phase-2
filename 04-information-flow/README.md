...
- For today's lecture `cd` into the directory `project_showcase`

- Run `npm start` to begin the React server

- Open a second terminal window to run `npm run server` to begin the JSON server
